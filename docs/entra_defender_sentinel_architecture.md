...
> **Nguồn:** Microsoft Learn (verified)  
...
## 2. Entra ID Protection — Signal Source (Nguồn Tín Hiệu)
...
## 3. Conditional Access — Enforcement Layer
...
## 4. Defender XDR — Alert & Correlation Engine
...
### Hạn chế: Defender XDR KHÔNG tự động correlate sign-in risk với data access
...
## 5. Microsoft Sentinel — SIEM/SOAR (Correlation & Automation)
...
## 6. Tổng Hợp: Signal Flow End-to-End
